...
import { PlatformReflectionCapabilities } from './platform-reflection-capabilities';
...
export class ReflectionCapabilities implements PlatformReflectionCapabilities {
  ...
  private _ownAnnotations(typeOrFunc: Type<any>, parentCtor: any): any[] | null {
    // Prefer the direct API.
    if (
      (typeOrFunc as any).annotations &&
      (typeOrFunc as any).annotations !== parentCtor.annotations
    ) {
    ...
    // API of tsickle for lowering decorators to properties on the class.
    if (
      (typeOrFunc as any).decorators &&
      (typeOrFunc as any).decorators !== parentCtor.decorators
    ) {
  ...
  private _ownPropMetadata(typeOrFunc: any, parentCtor: any): { [key: string]: any[] } | null {
    // Prefer the direct API.
    if (
      (typeOrFunc as any).propMetadata &&
    ...
    // API of tsickle for lowering decorators to properties on the class.
    if (
      (typeOrFunc as any).propDecorators &&
